...
bool AVFrameConvert::init()
{
    ...
    m_convertCtx = sws_getContext(m_srcWidth, m_srcHeight, m_srcFormat, m_dstWidth, m_dstHeight, m_dstFormat, SWS_BICUBIC, nullptr, nullptr, nullptr);
    if (!m_convertCtx) {
        return false;
    }
    return true;
