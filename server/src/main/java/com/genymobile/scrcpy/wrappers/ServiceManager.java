...
public final class ServiceManager {
    ...
    static {
        try {
            GET_SERVICE_METHOD = Class.forName("android.os.ServiceManager").getDeclaredMethod("getService",
                    String.class);
        } catch (Exception e) {
    ...
    // The DisplayManager may be used from both the Controller thread and the video
    // (main) thread
