...
public final class KcpConfig {
    ...
    /** 默认更新间隔 (ms) - P-KCP: 1ms极致低延迟 (原10ms) */
    ...
    /** 快速模式: 更新间隔 - P-KCP: 1ms极致低延迟 (原10ms) */
    public static final int FAST_MODE_INTERVAL = 1;
    ...
    /** 快速模式: 最小 RTO - P-KCP: 1ms极致低延迟 (原10ms) */
    public static final int FAST_MODE_MIN_RTO = 1;
    ...
    /** 视频流缓冲时间 (ms) - 用于计算窗口大小，300ms为VBR运动峰值预留余量 */
    public static final int VIDEO_BUFFER_MS = 300;
